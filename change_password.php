...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if ($p) { // If everything's OK.
		...
		if (mysqli_affected_rows($dbc) == 1) { // If it ran OK.
			...
			echo '<p class="error">Your password was not changed. Make sure your new
			password is different than the current password. Contact the system administrator
			if you think an error occurred.</p>';
...
<form action="change_password.php" method="post">
	...
	letters, numbers, and the underscore. Must be between 4 and 20 characters long.</small></p>
